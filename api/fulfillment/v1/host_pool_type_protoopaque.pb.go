...
type HostPoolStatus struct {
	state                 protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_State      HostPoolState               `protobuf:"varint,1,opt,name=state,proto3,enum=fulfillment.v1.HostPoolState"`
...
type HostPoolCondition struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Type               HostPoolConditionType  `protobuf:"varint,1,opt,name=type,proto3,enum=fulfillment.v1.HostPoolConditionType"`
...
var file_fulfillment_v1_host_pool_type_proto_rawDesc = string([]byte{
	...
	0x5f, 0x44, 0x45, 0x47, 0x52, 0x41, 0x44, 0x45, 0x44, 0x10, 0x04, 0x42, 0xc8, 0x01, 0x0a, 0x12,
