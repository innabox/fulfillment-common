...
type HostStatus struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_State      HostState              `protobuf:"varint,1,opt,name=state,proto3,enum=private.v1.HostState"`
	xxx_hidden_PowerState HostPowerState         `protobuf:"varint,2,opt,name=power_state,json=powerState,proto3,enum=private.v1.HostPowerState"`
	xxx_hidden_Conditions *[]*HostCondition      `protobuf:"bytes,3,rep,name=conditions,proto3"`
	xxx_hidden_HostPool   string                 `protobuf:"bytes,4,opt,name=host_pool,json=hostPool,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type HostCondition struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Type               HostConditionType      `protobuf:"varint,1,opt,name=type,proto3,enum=private.v1.HostConditionType"`
...
var file_private_v1_host_type_proto_rawDesc = string([]byte{
	...
	0x46, 0x10, 0x02, 0x42, 0xaa, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x69, 0x76,
